...
All contributions are welcome, though we have a few requests of contributors:

* **Follow styling guidelines.**
  Please take a look at the [Archipelago code style documentation](https://github.com/ArchipelagoMW/Archipelago/blob/main/docs/style.md) to ensure ease of communication and uniformity.
...
[#future-game-design > Gato Roboto](https://discord.com/channels/731205301247803413/1205195046689841217) thread of the [Archipelago Discord](https://archipelago.gg/discord).
